...
public class ViewBookingDetailPage {
    WebDriver driver;
    String title;
    By titleViewBookingDetalSelector = By.xpath("//div[@class='card-body']/h4");
    ...
    public String getTitleViewBookingDetailPage() {
        String titleViewBookingDetail = driver.findElement(titleViewBookingDetalSelector).getText();
